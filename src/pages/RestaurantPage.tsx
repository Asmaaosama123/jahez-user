  ...
  return (
    <div className="relative bg-gray-100 min-h-screen font-sans" dir={language === "ar" ? "rtl" : "ltr"}>
      ...
      <div className="relative">
        ...
        <div
          className={`absolute bottom-3 ${language === "ar" ? "right-3" : "left-3"
        ...
        >
          ...
          {/* النصوص */}
          <div
            className={`flex flex-col ${language === "ar" ? "text-right items-start" : "text-left items-start"
              }`}
          >
            ...
            <span
              className={`text-[10px] mt-1 ${storeInfo?.isOpen ? "text-green-400" : "text-red-700"
                }`}
            >
      ...
      <div className="flex gap-2 overflow-x-auto px-4 py-5 bg-gray-100 shadow">
        ...
        {storeInfo.jahezBoxActive &&
          sections.some(tab => ["جاهز بوكس", "Jahez Box"].includes(tab.name)) && (
            <button
              key="jahezbox"
              className={`flex-shrink-0 rounded-md transition p-1 m-0 min-w-[80px] h-10 ${selectedTab === "جاهز بوكس" || selectedTab === "Jahez Box" ? "bg-blue-500 text-white" : "bg-gray-300 text-black"
                }`}
              onClick={() => {
        ...
        {sections
          ...
          .map((tab) => (
            <button
              key={tab.id}
              className={`px-8 py-2 rounded-md text-sm whitespace-nowrap ${selectedTab === tab.name ? "bg-green-700 text-white" : "bg-white text-gray-600"
                }`}
